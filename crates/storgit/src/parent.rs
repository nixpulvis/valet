...
pub(crate) type ParentState = (BTreeMap<Id, gix::ObjectId>, BTreeMap<Id, Vec<u8>>);
...
pub(crate) fn entry_filename_as_id(filename: &BString) -> Result<Id, Error> {
...
pub(crate) fn serialize_gitmodules(gitlinks: &BTreeMap<Id, gix::ObjectId>) -> Vec<u8> {
